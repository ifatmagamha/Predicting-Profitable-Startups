...
class TestStartupScraper(unittest.TestCase):
    ...
    def setUp(self):  # this method is called before each test method in the class to prepare the test environment
        self.driver_path = r"C:\Users\Fatma\Downloads\edgedriver_win64\msedgedriver.exe"
        self.url = "https://venture.angellist.com/v/gamha-islem-fatma/i/gamha-islem-fatma/syndicates/all"
    ...
    def test_wait_for_login(self, mock_input):
        ...
        mock_driver.current_url = "https://venture.angellist.com/v/gamha-islem-fatma/i/gamha-islem-fatma/syndicates/all"
